...
import { Search, Monitor, Smartphone, Cpu, LogIn, LogOut, ArrowUp, ArrowDown } from "lucide-react";
...
export default function Home() {
  ...
  // Use debounce in real app, simple state binding here
  ...
  const moveGame = (id: number, direction: 'up' | 'down') => {
    ...
    // Assign new orders based on array position (reversed since we sort desc)
